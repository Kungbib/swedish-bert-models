...
The BERT tokenizer often splits strings into multiple tokens, with the subparts starting with `##`, for example the string "Engelbert kör Volvo" tokenized to `Engel ##bert kör Volvo`. To "glue" them back together one can use something the following:
